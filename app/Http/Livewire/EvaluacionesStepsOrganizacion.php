...
class EvaluacionesStepsOrganizacion extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.evaluaciones-steps-organizacion', ['evaluacion' => $evaluacion, 'areas' => $areas, 'empleados' => $empleados, 'grupos_evaluados' => $grupos_evaluados, 'competencias' => $competencias, 'tipos' => $tipos]);
    }
