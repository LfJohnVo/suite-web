<div class="w-100">
    ...
    <form id="form_timesheet" action="{{ route('admin.timesheet.store') }}" method="POST">
        @csrf
        <div class="form-group d-flex align-items-center card-mobile caja-calendar-semana" wire:ignore
            style="position: relative">
            <label class="mr-2" style="margin-top: 5px;"><i class="fas fa-calendar-alt iconos-crear"></i>Semana
                laboral</label>
            ...
            <table id="datatable_timesheet_create"
                ...
                <tbody>
                    ...
                    @for ($i = 1; $i <= $contador; $i++)
                        <tr id="tr_time_{{ $i }}" wire:ignore class="card-mobile tr-time-actividad-mobile"
                            data-title="Actividad {{ $i }}">
                            <td wire:ignore>
                                ...
                                @if ($i > 1)
                                    <div class="btn btn_destroy_tr" data-tr="tr_time_{{ $i }}"
                                        style="color:red; font-size:20px;" title="Eliminar fila"><i
                                            ...
                                            class="text-eliminar-actividad-mobile" style="margin-left: 10px;">Eliminar
                                            actividad</small></div>
                                @endif
                            </td>
                            <td>
