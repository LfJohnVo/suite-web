<div>
    ...
    <ul id="progressbar">
        <li class="active" id="createEvaluacion"><strong>Inicio</strong></li>
        <li id="publicoObjetivo"><strong>Periodos</strong></li>
        <li id="evaluadores"><strong>Público</strong></li>
        <li id="periodosCircle"><strong>Evaluadores Competencias</strong></li>
    </ul>
                                        ...
                                        <div class="col-sm-12 col-lg-12 col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" wire:model.defer="nombre"
                                                    ...
                                                    value="{{ old('nombre') }}">
                                                <small id="nombreHelp" class="form-text text-muted">Ingresa el nombre de
                                                    la
                                                    evaluación</small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mt-3 row align-items-center">
                                                    ...
                                                    <div class="col-7 {{ $showPesoGeneralCompetencias ? '' : 'd-none' }}"
                                                        ...
                                                        <input
                                                            style="width: 120px;text-align: center;padding-right: 20px;"
                                                ...
                                                <div class="mt-3 row align-items-center">
                                                    ...
                                                    <div
                                                        class="col-7 {{ $showPesoGeneralObjetivos ? '' : 'd-none' }}">
                                                        <input
                                                            style="width: 120px;text-align: center;padding-right: 20px;"
                                                ...
                                                <div class="row w-100">
                                                    ...
                                                    <div class="col-11">
                                                        ...
                                                        <p class="m-0" style="font-size: 14px; color:#1E3A8A ">
                                                            ...
                                                            organización, áreas en específico, grupos creados o
                                                            selección
                                                            manual por
                                                            empleados.
                                            ...
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-9">
                                                    ...
                                                    <label class="mb-0" for="descripcion">
                                                        <i class="fas fa-users iconos-crear"></i> Público objetivo
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="" selected>-- Seleciona una opción --
                                                        </option>
                                                    ...
                                                    @if ($habilitarSelectAreas)
                                                        <select
                                                            ...
                                                            <option value="" selected>-- Seleciona el área a
                                                                evaluar
                                                                --
                                                            </option>
                                                    ...
                                                    @if ($habilitarSelectManual)
                                                        <label class="m-0 mt-2" for="">Selecciona a los
                                                            empleados
                                                            a
                                                            evaluar</label>
                                                        <select
                                                        ...
                                                        <small class="form-text text-muted">Importante: No se creará un
                                                            nuevo grupo,esta opción es recomendada para selecciones de
                                                            una
                                                            sola vez</small>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-11">
                                                <p class="m-0"
                                                    ...
                                                    Instrucciones</p>
                                                <p class="m-0" style="font-size: 14px; color:#1E3A8A ">
                                                    Ahora define el peso porcentual de cada evaluador, repartiendo el
                                                    100%
                                                    entre todos ellos.
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-8" wire:loading.class="disableEvents">
                                            ...
                                            <article class="feature2">
                                                <input readonly disabled type="checkbox"
                                                    ...
                                                    wire:target="evaluado_por_misma_area"
                                            ...
                                            <article class="mt-4 feature4">
                                                <input readonly disabled type="checkbox"
                                                    ...
                                                    wire:model="autoevaluacion" id="feature4"
                            ...
                            <div>
                                ...
                                <p class="m-0 text-muted"><i class="fas fa-info-circle"></i>
                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-11">
                                                <p class="m-0"
                                                    ...
                                                    Instrucciones</p>
                                                <p class="m-0" style="font-size: 14px; color:#1E3A8A ">
                                                    Por último, define el número de veces que se aplicará la evaluación
                                                    y el
                                                    periodo
                                    ...
                                    <button class="mt-4 btn btn-sm btn-outline-primary" id="addPeriodo"
                                        wire:click="addPeriodo()"><i class="mr-2 fas fa-plus"></i> Añadir
                                        Periodo</button>
                                    <hr>
                    ...
                    @if ($currentStep == 5)
                        <div class="step-four">
                            <div>
                                ...
                                <div class="card-body">
                                    <h2 class="mt-2 text-center purple-text"><strong>¡EVALUACIÓN CREADA!</strong></h2>
                                    <br>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="text-center col-7">
                                            <h5 class="text-center purple-text">
                                                Su evaluación ha sido creada satisfactoriamente, los evaluadores
                                                recibirán
